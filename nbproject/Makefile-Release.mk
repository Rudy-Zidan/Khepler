...
${OBJECTDIR}/Crawler.o: Crawler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Crawler.o Crawler.cpp

${OBJECTDIR}/HTML/HtmlExtractor.o: HTML/HtmlExtractor.cpp 
	${MKDIR} -p ${OBJECTDIR}/HTML
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/HTML/HtmlExtractor.o HTML/HtmlExtractor.cpp

${OBJECTDIR}/Structure/CrawlerStructure.o: Structure/CrawlerStructure.cpp 
	${MKDIR} -p ${OBJECTDIR}/Structure
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Structure/CrawlerStructure.o Structure/CrawlerStructure.cpp

${OBJECTDIR}/URLConnection/URLConnection.o: URLConnection/URLConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}/URLConnection
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/URLConnection/URLConnection.o URLConnection/URLConnection.cpp
